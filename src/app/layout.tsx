...
export const metadata = {
  title:
    "Их таван нүдэн | Гадаад худалдаа | Уул уурхай, хүнд даацын техник, тоног төхөөрөмж, сэлбэг хэрэгсэл | Барилгын материалын худалдаа | Цэцэрлэгжүүлэлт | ikh tavan nuden | ikhtavannuden.mn",
